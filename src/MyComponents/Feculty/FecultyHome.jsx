...
const FecultyHome = () => {
  ...
  useEffect(() => {
    axios
      .post("http://localhost:5000/api/student/annoucement" , {for:'feculty'})
  ...
  <div className="flex w-screen">
    <FecultyHomeHelper />
    <div className="gird w-screen flex">
  ...
  <div className="flex">
      ...
      <div className="flex flex-col items-center border-x overflow-scroll p-6 w-1/3">
